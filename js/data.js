...
/**
 * ============================================================================
 * 📦 MAPLE OMNI - 2026 최신 데이터베이스 (data.js)
 * 모든 직업의 카루타, 앱솔, 아케인, 에테르넬 및 해방/특수 무기 포함
 * ============================================================================
 */
...
const COMMON_ARMOR_DB = {
    ...
    "전사": {
        ...
        "무기": [
            "제네시스 두손검", "제네시스 창", "제네시스 폴암", "제네시스 한손검", "제네시스 한손도끼", "제네시스 두손도끼", "제네시스 한손둔기", "제네시스 두손둔기", "제네시스 데스페라도", "제네시스 튜너",
            "아케인셰이드 두손검", "아케인셰이드 창", "아케인셰이드 폴암", "아케인셰이드 튜너",
            "데스티니 슬래셔", "데스티니 클레이모어", "아스트라 브레이커", "아스트라 세이버",
            "앱솔랩스 브로드세이버", "앱솔랩스 숄더캐논"
        ]
    },
    "마법사": {
        ...
        "무기": [
            "제네시스 스태프", "제네시스 완드", "제네시스 샤이닝 로드", "제네시스 ESP 리미터", "제네시스 매직 건틀렛",
            "아케인셰이드 스태프", "아케인셰이드 완드", "아케인셰이드 샤이닝 로드",
            "데스티니 스펠로어", "아스트라 매직로드",
            "앱솔랩스 스펠스태프"
        ]
    },
    "궁수": {
        ...
        "무기": [
            "제네시스 보우", "제네시스 크로스보우", "제네시스 듀얼 보우건", "제네시스 에인션트 보우", "제네시스 브레스 슈터",
            "아케인셰이드 보우", "아케인셰이드 크로스보우", "아케인셰이드 에인션트 보우",
            "데스티니 샤프슈터", "아스트라 헌팅보우",
            "앱솔랩스 슈팅보우"
        ]
    },
    "도적": {
        ...
        "무기": [
            "제네시스 대거", "제네시스 아대", "제네시스 케인", "제네시스 에너지 소드", "제네시스 부채", "제네시스 차크람",
            "아케인셰이드 단검", "아케인셰이드 아대", "아케인셰이드 케인",
            "데스티니 다크블레이드", "아스트라 엣지",
            "앱솔랩스 가즈"
        ]
    },
    "해적": {
        ...
        "무기": [
            "제네시스 너클", "제네시스 건", "제네시스 핸드캐논", "제네시스 소울 슈터", "제네시스 에이전트",
            "아케인셰이드 너클", "아케인셰이드 피스톨", "아케인셰이드 핸드캐논",
            "데스티니 캐논로드", "아스트라 버스터",
            "앱솔랩스 숄더캐논"
        ]
    }
